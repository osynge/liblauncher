...
impl RedirectFactory {
    ...
    pub fn generate_process(&mut self) -> Result<RedirectProcess, const_api::LauncherError> {
        let bill = RedirectProcess {
            file_descriptor_read: None,
            file_descriptor_write: None,
            file_descriptor_child: self.file_descriptor_child,
            file_descriptor_pairent: self.file_descriptor_pairent,
